...
| **React UI** | `.jsx` + React 19 | Componenti moderni, Context API, interamente generata tramite AI. | [🔗 React-One-Prompt-EM](https://github.com/CristianRegusini/Earthquake-Map/tree/One-Prompt-Earthquake-Map) |
